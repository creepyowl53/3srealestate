  ...
  const actions = [
    {
      ...
      href: `https://wa.me/${whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent('Hi 3S Real Estate! I\'m interested in your properties. Please guide me.')}`,
      external: true,
    },
    {
      icon: Phone,
...
// Standalone WhatsApp float button
export function WhatsAppFloat() {
  const number = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER?.replace(/[^0-9]/g, '') || '919876543210'
  const message = encodeURIComponent('Hi 3S Real Estate! I\'m interested in your properties.')
